...
class QualificationsSubFormTest(FlaskForm):
    selector = SelectField(choices=[('1', 'one'), ('2', 'two')])
    first_select = SelectField(choices=[('1', 'apples'), ('2', 'oranges')])
    second_select = SelectField(choices=[('1', 'true'), ('2', 'false')])
