...
*/
    ...
    CKEDITOR.config.coreStyles_superscript = { element: "sup" }; CKEDITOR.plugins.add("dialogui", {
        onLoad: function () {
    ...
    })(); CKEDITOR.plugins.add("dialog", { requires: "dialogui", init: function (w) { w.on("doubleclick", function (z) { z.data.dialog && w.openDialog(z.data.dialog) }, null, null, 999) } }); (function () {
    ...
    CKEDITOR.plugins.sourcearea = { commands: { source: { modes: { wysiwyg: 1, source: 1 }, editorFocus: !1, readOnly: 1, exec: function (c) { "wysiwyg" == c.mode && c.fire("saveSnapshot"); c.getCommand("source").setState(CKEDITOR.TRISTATE_DISABLED); c.setMode("source" == c.mode ? "wysiwyg" : "source") }, canUndo: !1 } } }; (function () {
        ...
        CKEDITOR.plugins.add("codemirror", {
            version: "1.17.10", init: function (b) {
                function h() { var a = ["core", "addons"]; switch (c.mode) { case "bbcode": case "bbcodemixed": a.push("modeHtml"); break; case "application/x-httpd-php": a.push("modePHP"); break; case "text/javascript": a.push("modeJs"); break; case "handlebars": a.push("modeHandlebars"); break; case "twig": a.push("modeTwig"); break; default: a.push("modeHtml") }c.useBeautifyOnStart && a.push("beautifyModule"); c.enableSearchTools && a.push("addonSearch"); return a }
                function m() {
                    var a = [e + "js/codemirror.addons.min.js"]; switch (c.mode) {
                        case "handlebars": a.push(e + "js/codemirror.mode.handlebars.min.js"); case "bbcode": a.push(e + "js/codemirror.mode.bbcode.min.js"); break; case "bbcodemixed": a.push(e + "js/codemirror.mode.bbcodemixed.min.js"); break; case "htmlmixed": a.push(e + "js/codemirror.mode.htmlmixed.min.js"); break; case "text/html": a.push(e + "js/codemirror.mode.htmlmixed.min.js"); break; case "application/x-httpd-php": a.push(e + "js/codemirror.mode.php.min.js"); break; case "text/javascript": a.push(e +
                            "js/codemirror.mode.javascript.min.js"); break; case "twig": a.push(e + "js/codemirror.mode.twig.min.js"); break; default: a.push(e + "js/codemirror.mode.htmlmixed.min.js")
                    }c.useBeautifyOnStart && a.push(e + "js/beautify.min.js"); c.enableSearchTools && a.push(e + "js/codemirror.addons.search.min.js"); return a
                } function k(a) {
                    function b(a) {
                        for (var c = [[CKEDITOR.SHIFT, "Shift-"], [CKEDITOR.CTRL, "Ctrl-"], [CKEDITOR.ALT, "Alt-"]], d = "", e = 0; e < c.length; e++)a & c[e][0] && (a -= c[e][0], d += c[e][1]); return CodeMirror.keyNames[a] ? d + CodeMirror.keyNames[a] :
                            null
                    } var g = a.ui.space("contents").getDocument().createElement("textarea"); g.setStyles(CKEDITOR.tools.extend({ width: CKEDITOR.env.ie7Compat ? "99%" : "100%", height: "100%", resize: "none", outline: "none", "text-align": "left" }, CKEDITOR.tools.cssVendorPrefix("tab-size", a.config.sourceAreaTabSize || 4))); var e = [a.lang.editor, a.name].join(); g.setAttributes({ dir: "ltr", tabIndex: CKEDITOR.env.webkit ? -1 : a.tabIndex, role: "textbox", "aria-label": e }); g.addClass("cke_source"); g.addClass("cke_reset"); g.addClass("cke_enable_context_menu");
                    a.ui.space("contents").append(g); window["editable_" + a.id] = a.editable(new d(a, g)); window["editable_" + a.id].setData(a.getData(1)); window["editable_" + a.id].editorID = a.id; a.fire("ariaWidget", this); g = window["editable_" + a.id]; e = g.getParent(); c.lineNumbers && c.enableCodeFolding && (window["foldFunc_" + a.id] = CodeMirror.newFoldFunction(CodeMirror.tagRangeFinder)); var h = { "Ctrl-Q": function (b) { if (c.enableCodeFolding) window["foldFunc_" + a.id](b, b.getCursor().line) } }; (function (c) {
                        var f = a.config.keystrokes; if (CKEDITOR.tools.isArray(f)) for (var d =
                            0; d < f.length; d++) { var e = b(f[d][0]); null !== e && function (b) { c[e] = function () { a.execCommand(b) } }(f[d][1]) }
                    })(h); window["codemirror_" + a.id] = CodeMirror.fromTextArea(g.$, {
                        mode: "handlebars" === c.mode ? { name: "handlebars", base: "text/html" } : c.mode, matchBrackets: c.matchBrackets, maxHighlightLineLength: c.maxHighlightLineLength, matchTags: c.matchTags, workDelay: 300, workTime: 35, readOnly: a.readOnly, lineNumbers: c.lineNumbers, lineWrapping: !0, autoCloseTags: c.autoCloseTags, autoCloseBrackets: c.autoCloseBrackets, highlightSelectionMatches: c.highlightMatches,
                        continueComments: c.continueComments, indentWithTabs: c.indentWithTabs, theme: c.theme, showTrailingSpace: c.showTrailingSpace, showCursorWhenSelecting: !0, styleActiveLine: c.styleActiveLine, extraKeys: h, foldGutter: !0, gutters: ["CodeMirror-linenumbers", "CodeMirror-foldgutter"]
                    }); g = 0 == e.$.clientHeight ? a.ui.space("contents").getStyle("height") : e.$.clientHeight + "px"; window["codemirror_" + a.id].config = c; c.autoFormatOnStart && (c.useBeautifyOnStart ? (e = window["codemirror_" + a.id].getValue(), window["codemirror_" + a.id].setValue(html_beautify(e,
                        4, " ", 120, "collapse"))) : window["codemirror_" + a.id].autoFormatAll({ line: 0, ch: 0 }, { line: window["codemirror_" + a.id].lineCount(), ch: 0 })); window["codemirror_" + a.id].on("change", function () { window["codemirror_" + a.id].save(); a.fire("change", this) }); window["codemirror_" + a.id].setSize(null, g); if (c.lineNumbers && c.enableCodeFolding) window["codemirror_" + a.id].on("gutterClick", window["foldFunc_" + a.id]); if ("function" === typeof c.onLoad) c.onLoad(window["codemirror_" + a.id], a); window["codemirror_" + a.id].on("blur", function () {
                            a.fire("blur",
                                this)
                        }); window["codemirror_" + a.id].on("keypress", function (b, f) {
                            if (c.enableCodeFormatting) {
                                var d = window["codemirror_" + a.id].getCursor(!0), e = window["codemirror_" + a.id].getCursor(!1); "keydown" !== f.type || !f.ctrlKey || 75 !== f.keyCode || f.shiftKey || f.altKey ? "keydown" === f.type && f.ctrlKey && 75 === f.keyCode && f.shiftKey && !f.altKey ? (window["codemirror_" + a.id].commentRange(!1, d, e), c.autoFormatOnUncomment && window["codemirror_" + a.id].autoFormatRange(d, e)) : "keydown" === f.type && f.ctrlKey && 75 === f.keyCode && !f.shiftKey &&
                    ...
                    autoCloseBrackets: !0, autoCloseTags: !0, autoFormatOnStart: !1, autoFormatOnUncomment: !1, autoLoadCodeMirror: !0, continueComments: !0, enableCodeFolding: !0, enableCodeFormatting: !0, enableSearchTools: !0, highlightMatches: !0, indentWithTabs: !1, lineNumbers: !0, lineWrapping: !0, mode: "htmlmixed", matchBrackets: !0, maxHighlightLineLength: 1E3, matchTags: !0, showAutoCompleteButton: !0,
                    showCommentButton: !0, showFormatButton: !0, showSearchButton: !0, showTrailingSpace: !0, showUncommentButton: !0, styleActiveLine: !0, theme: "default", useBeautifyOnStart: !1
                }, b.config.codemirror || {}, !0), n = b.lang.codemirror; b.config.codemirror_theme && (c.theme = b.config.codemirror_theme); b.config.codemirror_autoFormatOnStart && (c.autoFormatOnStart = b.config.codemirror_autoFormatOnStart); b.plugins.bbcode && 0 >= c.mode.indexOf("bbcode") && (c.mode = "bbcode"); var q = "function" === typeof require && "function" === typeof require.config,
                    r; if (q) {
                        var l = c.requireContext || "_", p = CKEDITOR.getUrl("plugins/codemirror/js"); r = require.config({
                            context: l, packages: [{ name: "codemirror", location: p, main: "codemirror.min.js" }, { name: "codemirror-mode-handlebars", location: p, main: "codemirror.mode.handlebars.min.js" }, { name: "codemirror-mode-twig", location: p, main: "codemirror.mode.twig.min.js" }, { name: "codemirror-mode-html", location: p, main: "codemirror.mode.htmlmixed.min.js" }, { name: "codemirror-mode-php", location: p, main: "codemirror.mode.php.min.js" }, {
                                name: "codemirror-mode-js",
                                location: p, main: "codemirror.mode.js.min.js"
                            }, { name: "codemirror-addons", location: p, main: "codemirror.addons.min.js" }, { name: "codemirror-addon-search", location: p, main: "codemirror.addons.search.min.js" }, { name: "codemirror-beautify", location: p, main: "beautify.min.js" }], bundles: {
                                codemirror: ["core", "codemirror.js"], "codemirror-mode-handlebars": ["modeHandlebars"], "codemirror-mode-twig": ["modeTwig"], "codemirror-mode-html": ["modeHtml"], "codemirror-mode-php": ["modePHP"], "codemirror-mode-js": ["modeJS"], "codemirror-addons": ["addons"],
                        ...
                        function b(a, d, e) {
                            var g = e.getSize(); e = g.width; g = g.height / 1.5; window["codemirror_" + a.id] = CodeMirror.fromTextArea(d, {
                                mode: "handlebars" === c.mode ? { name: "handlebars", base: "text/html" } : c.mode, matchBrackets: c.matchBrackets, maxHighlightLineLength: c.maxHighlightLineLength,
                                ...
                                }, foldGutter: !0, gutters: ["CodeMirror-linenumbbers", "CodeMirror-foldgutter"]
                            }); d = g + "px"; e += "px"; window["codemirror_" + a.id].config = c; c.autoFormatOnStart && (c.useBeautifyOnStart ? (g = window["codemirror_" + a.id].getValue(), window["codemirror_" + a.id].setValue(html_beautify(g, 4, " ", 120, "collapse"))) : window["codemirror_" + a.id].autoFormatAll({ line: 0, ch: 0 }, { line: window["codemirror_" + a.id].lineCount(), ch: 0 })); window["codemirror_" + a.id].on("change", function () {
                                window["codemirror_" + a.id].save();
                                a.fire("change", this)
                            }); window["codemirror_" + a.id].setSize(e, d); if (c.lineNumbers && c.enableCodeFolding) window["codemirror_" + a.id].on("gutterClick", window["foldFunc_" + a.id]); if ("function" === typeof c.onLoad) c.onLoad(window["codemirror_" + a.id], a); window["codemirror_" + a.id].on("blur", function () { a.fire("blur", this) }); window["codemirror_" + a.id].on("keypress", function (b, d) {
                                if (c.enableCodeFormatting) {
                                    var e = window["codemirror_" + a.id].getCursor(!0), f = window["codemirror_" + a.id].getCursor(!1); "keydown" !== d.type ||
                        ...
                        } var d = CKEDITOR.document.getWindow().getViewPaneSize(), k = Math.min(d.width - 70, 800), d = d.height / 1.5, l; return {
                            title: a.lang.sourcedialog.title, minWidth: k, minHeight: d, resizable: CKEDITOR.DIALOG_RESIZE_BOTH, onLoad: function () {
                                this.on("resize",
                                    function (b) { var c = b.sender.parts; window["codemirror_" + a.id].setSize(b.data.width + "px", b.data.height - c.title.$.offsetHeight - c.footer.$.offsetHeight + "px") }, this)
                            }, onShow: function (d) {
                                this.getContentElement("main", "data").focus(); this.getContentElement("main", "AutoComplete").setValue(c.autoCloseTags, !0); var f = this.getContentElement("main", "data").getInputElement().$; this.setValueOf("main", "data", l = a.getData()); c.autoLoadCodeMirror && (IsStyleSheetAlreadyLoaded(e + "css/codemirror.min.css") || CKEDITOR.document.appendStyleSheet(e +
                                    "css/codemirror.min.css"), c.theme.length && "default" != c.theme && !IsStyleSheetAlreadyLoaded(e + "theme/" + c.theme + ".css") && CKEDITOR.document.appendStyleSheet(e + "theme/" + c.theme + ".css"), q ? r(h(), function (c, e) { b(a, f, d.sender) }) : "undefined" == typeof CodeMirror ? CKEDITOR.scriptLoader.load(e + "js/codemirror.min.js", function () { CKEDITOR.scriptLoader.load(m(), function () { b(a, f, d.sender) }) }) : CodeMirror.prototype.autoFormatAll ? b(a, f, d.sender) : CKEDITOR.scriptLoader.load(m(), function () { b(a, f, d.sender) }))
                            }, onCancel: function (b) {
                                b.data.hide &&
                                (window["codemirror_" + a.id].toTextArea(), window["codemirror_" + a.id] = null, a.fire("blur", this), a.fire("focus", this))
                            }, onOk: function () {
                                function b(c) { var d = this; a.setData(c, function () { d.hide(); var b = a.createRange(); b.moveToElementEditStart(a.editable()); b.select() }) } return function () {
                                    window["codemirror_" + a.id].toTextArea(); window["codemirror_" + a.id] = null; var c = this.getValueOf("main", "data").replace(/\r/g, ""); if (c === l) return a.fire("blur", this), a.fire("focus", this), !0; CKEDITOR.env.ie ? CKEDITOR.tools.setTimeout(b,
                                        0, this, c) : b.call(this, c); a.fire("blur", this); a.fire("focus", this); return !1
                                }
                            }(), contents: [{
                                id: "main", label: a.lang.sourcedialog.title, elements: [{
                                    type: "hbox", style: "width: 80px;margin:0;", widths: ["20px", "20px", "20px", "20px"], children: [{ type: "button", id: "searchCode", label: "", title: n.searchCode, "class": "searchCodeButton", onClick: function () { CodeMirror.commands.find(window["codemirror_" + a.id]) } }, {
                                        type: "button", id: "autoFormat", label: "", title: n.autoFormat, "class": "autoFormat", onClick: function () {
                                            var b = window["codemirror_" +
                                                a.id].getCursor(!0), c = window["codemirror_" + a.id].getCursor(!1); window["codemirror_" + a.id].autoFormatRange(b, c)
                                        }
                                    }, { type: "button", id: "CommentSelectedRange", label: "", title: n.commentSelectedRange, "class": "CommentSelectedRange", onClick: function () { var b = window["codemirror_" + a.id].getCursor(!0), c = window["codemirror_" + a.id].getCursor(!1); window["codemirror_" + a.id].commentRange(!0, b, c) } }, {
                                        type: "button", id: "UncommentSelectedRange", label: "", title: n.uncommentSelectedRange, "class": "UncommentSelectedRange", onClick: function () {
                                            var b =
                                                window["codemirror_" + a.id].getCursor(!0), c = window["codemirror_" + a.id].getCursor(!1); window["codemirror_" + a.id].commentRange(!1, b, c); window["codemirror_" + a.id].config.autoFormatOnUncomment && window["codemirror_" + a.id].autoFormatRange(b, c)
                                        }
                                    }]
                                }, { type: "checkbox", id: "AutoComplete", label: n.autoCompleteToggle, title: n.autoCompleteToggle, onChange: function () { window["codemirror_" + a.id].setOption("autoCloseTags", this.getValue()) } }, {
                                    type: "textarea", id: "data", dir: "ltr", inputStyle: "cursor:auto;width:" + k + "px;height:" +
                                        d + "px;tab-size:4;text-align:left;", "class": "cke_source cke_enable_context_menu"
                                }]
                            }]
                        }
                    }); b.commands.find && (b.commands.find.modes = { wysiwyg: 1, source: 1 }, b.commands.find.exec = function () { "wysiwyg" === b.mode ? b.openDialog("find") : CodeMirror.commands.find(window["codemirror_" + b.id]) }); b.commands.replace && (b.commands.replace.modes = { wysiwyg: 1, source: 1 }, b.commands.replace.exec = function () {
                        "wysiwyg" === b.mode ? b.openDialog("find", function () { this.selectPage("replace") }) : CodeMirror.commands.replace(window["codemirror_" +
                            b.id])
                    }); l = CKEDITOR.plugins.sourcearea; l.commands.searchCode || (CKEDITOR.plugins.sourcearea.commands = {
                        source: { modes: { wysiwyg: 1, source: 1 }, editorFocus: !1, readOnly: 1, exec: function (a) { "wysiwyg" === a.mode && a.fire("saveSnapshot"); a.getCommand("source").setState(CKEDITOR.TRISTATE_DISABLED); a.setMode("source" === a.mode ? "wysiwyg" : "source") }, canUndo: !1 }, searchCode: { modes: { wysiwyg: 0, source: 1 }, editorFocus: !1, readOnly: 1, exec: function (a) { CodeMirror.commands.find(window["codemirror_" + a.id]) }, canUndo: !0 }, autoFormat: {
                            modes: {
                                wysiwyg: 0,
                                source: 1
                            }, editorFocus: !1, readOnly: 1, exec: function (a) { var b = window["codemirror_" + a.id].getCursor(!0), c = window["codemirror_" + a.id].getCursor(!1); window["codemirror_" + a.id].autoFormatRange(b, c) }, canUndo: !0
                        }, commentSelectedRange: { modes: { wysiwyg: 0, source: 1 }, editorFocus: !1, readOnly: 1, exec: function (a) { var b = window["codemirror_" + a.id].getCursor(!0), c = window["codemirror_" + a.id].getCursor(!1); window["codemirror_" + a.id].commentRange(!0, b, c) }, canUndo: !0 }, uncommentSelectedRange: {
                            modes: { wysiwyg: 0, source: 1 }, editorFocus: !1,
                            readOnly: 1, exec: function (a) { var b = window["codemirror_" + a.id].getCursor(!0), c = window["codemirror_" + a.id].getCursor(!1); window["codemirror_" + a.id].commentRange(!1, b, c); window["codemirror_" + a.id].config.autoFormatOnUncomment && window["codemirror_" + a.id].autoFormatRange(b, c) }, canUndo: !0
                        }, autoCompleteToggle: {
                            modes: { wysiwyg: 0, source: 1 }, editorFocus: !1, readOnly: 1, exec: function (a) {
                            this.state == CKEDITOR.TRISTATE_ON ? window["codemirror_" + a.id].setOption("autoCloseTags", !1) : this.state == CKEDITOR.TRISTATE_OFF && window["codemirror_" +
                                a.id].setOption("autoCloseTags", !0); this.toggleState()
                            }, canUndo: !0
                        }
                    }); b.addMode("source", function (a) {
                    c.autoLoadCodeMirror && (IsStyleSheetAlreadyLoaded(e + "css/codemirror.min.css") || CKEDITOR.document.appendStyleSheet(e + "css/codemirror.min.css"), c.theme.length && "default" != c.theme && !IsStyleSheetAlreadyLoaded(e + "theme/" + c.theme + ".css") && CKEDITOR.document.appendStyleSheet(e + "theme/" + c.theme + ".css"), q ? r(h(), function () { k(b); a() }) : "undefined" == typeof CodeMirror ? CKEDITOR.scriptLoader.load(e + "js/codemirror.min.js",
                        function () { CKEDITOR.scriptLoader.load(m(), function () { k(b); a() }) }) : CodeMirror.prototype.autoFormatAll ? (k(b), a()) : CKEDITOR.scriptLoader.load(m(), function () { k(b); a() }))
                    }); b.addCommand("source", l.commands.source); b.ui.addButton && b.ui.addButton("Source", { label: b.lang.codemirror.toolbar, command: "source", toolbar: "mode,10" }); c.enableCodeFormatting && (b.addCommand("searchCode", l.commands.searchCode), b.addCommand("autoFormat", l.commands.autoFormat), b.addCommand("commentSelectedRange", l.commands.commentSelectedRange),
                        b.addCommand("uncommentSelectedRange", l.commands.uncommentSelectedRange), b.addCommand("autoCompleteToggle", l.commands.autoCompleteToggle), b.ui.addButton && ((c.showFormatButton || c.showCommentButton || c.showUncommentButton || c.showSearchButton) && b.ui.add("-", CKEDITOR.UI_SEPARATOR, { toolbar: "mode,30" }), c.showSearchButton && c.enableSearchTools && b.ui.addButton("searchCode", { label: n.searchCode, command: "searchCode", toolbar: "mode,40" }), c.showFormatButton && b.ui.addButton("autoFormat", {
                            label: n.autoFormat, command: "autoFormat",
                            toolbar: "mode,50"
                        }), c.showCommentButton && b.ui.addButton("CommentSelectedRange", { label: n.commentSelectedRange, command: "commentSelectedRange", toolbar: "mode,60" }), c.showUncommentButton && b.ui.addButton("UncommentSelectedRange", { label: n.uncommentSelectedRange, command: "uncommentSelectedRange", toolbar: "mode,70" }), c.showAutoCompleteButton && b.ui.addButton("AutoComplete", { label: n.autoCompleteToggle, command: "autoCompleteToggle", toolbar: "mode,80" }))); b.on("beforeModeUnload", function (a) {
                            if ("source" === b.mode &&
                                b.plugins.textselection && !b.config.fullPage) { var c = b.getTextSelection(); c.startOffset = LineChannelToOffSet(window["codemirror_" + b.id], window["codemirror_" + b.id].getCursor(!0)); c.endOffset = LineChannelToOffSet(window["codemirror_" + b.id], window["codemirror_" + b.id].getCursor(!1)); delete c.element; c.createBookmark(b); sourceBookmark = !0; b.undoManager && b.undoManager.unlock(); a.data = c.content }
                        }); b.on("mode", function () {
                            b.getCommand("source").setState("source" === b.mode ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF);
                            if ("source" === b.mode && (b.getCommand("autoCompleteToggle").setState(window["codemirror_" + b.id].config.autoCloseTags ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF), b.plugins.textselection && textRange && !b.config.fullPage)) {
                                var a, c; a = OffSetToLineChannel(window["codemirror_" + b.id], textRange.startOffset); "undefined" == typeof textRange.endOffset ? (window["codemirror_" + b.id].focus(), window["codemirror_" + b.id].setCursor(a)) : (window["codemirror_" + b.id].focus(), c = OffSetToLineChannel(window["codemirror_" + b.id], textRange.endOffset),
                                    window["codemirror_" + b.id].setSelection(a, c))
                            }
                        }); b.on("resize", function () { if (window["editable_" + b.id] && "source" === b.mode) { var a = window["editable_" + b.id].getParent(); window["codemirror_" + b.id].setSize(a.$.clientWidth + "px", a.$.clientHeight + "px") } }); b.on("readOnly", function () { window["editable_" + b.id] && "source" === b.mode && window["codemirror_" + b.id].setOption("readOnly", this.readOnly) }); b.on("instanceReady", function (a) {
                            a = b.commands.selectAll; null != a && (a.exec = function () {
                                if ("source" === b.mode) window["codemirror_" +
                                    b.id].setSelection({ line: 0, ch: 0 }, { line: window["codemirror_" + b.id].lineCount(), ch: 0 }); else { var a = b.editable(); if (a.is("body")) b.document.$.execCommand("SelectAll", !1, null); else { var c = b.createRange(); c.selectNodeContents(a); c.select() } b.forceNextSelectionCheck(); b.selectionChange() }
                            })
                        }); if ("undefined" != typeof jQuery && jQuery('a[data-toggle\x3d"tab"]') && window["codemirror_" + b.id]) jQuery('a[data-toggle\x3d"tab"]').on("shown.bs.tab", function () { window["codemirror_" + b.id].refresh() }); b.on("setData", function (a) {
                        window["editable_" +
                            a.editor.id] && "source" === a.editor.mode && window["codemirror_" + a.editor.id].setValue(a.data.dataValue)
                        })
            }
        }); var d = CKEDITOR.tools.createClass({
            base: CKEDITOR.editable, proto: {
                setData: function (b) { this.setValue(b); window["editable_" + this.editor.id] && "source" === this.editor.mode && window["codemirror_" + this.editor.id].setValue(b); this.editor.fire("dataReady") }, getData: function () { return this.getValue() }, insertHtml: function () { }, insertElement: function () { }, insertText: function () { }, setReadOnly: function (b) {
                    this[(b ?
                        "set" : "remove") + "Attribute"]("readOnly", "readonly")
                }, editorID: null, detach: function () { window["codemirror_" + this.editorID].toTextArea(); window["editable_" + this.editorID] = null; window["codemirror_" + this.editorID] = null; d.baseProto.detach.call(this); this.clearCustomData(); this.remove() }
            }
        })
    })();
    CKEDITOR.plugins.sourcearea = {
        commands: {
            source: { modes: { wysiwyg: 1, source: 1 }, editorFocus: !1, readOnly: 1, exec: function (d) { "wysiwyg" === d.mode && d.fire("saveSnapshot"); d.getCommand("source").setState(CKEDITOR.TRISTATE_DISABLED); d.setMode("source" === d.mode ? "wysiwyg" : "source") }, canUndo: !1 }, searchCode: { modes: { wysiwyg: 0, source: 1 }, editorFocus: !1, readOnly: 1, exec: function (d) { CodeMirror.commands.find(window["codemirror_" + d.id]) }, canUndo: !0 }, autoFormat: {
                modes: { wysiwyg: 0, source: 1 }, editorFocus: !1, readOnly: 0, exec: function (d) {
                    var b =
                        window["codemirror_" + d.id].getCursor(!0), h = window["codemirror_" + d.id].getCursor(!1); window["codemirror_" + d.id].autoFormatRange(b, h)
                }, canUndo: !0
            }, commentSelectedRange: { modes: { wysiwyg: 0, source: 1 }, editorFocus: !1, readOnly: 0, exec: function (d) { var b = window["codemirror_" + d.id].getCursor(!0), h = window["codemirror_" + d.id].getCursor(!1); window["codemirror_" + d.id].commentRange(!0, b, h) }, canUndo: !0 }, uncommentSelectedRange: {
                modes: { wysiwyg: 0, source: 1 }, editorFocus: !1, readOnly: 0, exec: function (d) {
                    var b = window["codemirror_" +
                        d.id].getCursor(!0), h = window["codemirror_" + d.id].getCursor(!1); window["codemirror_" + d.id].commentRange(!1, b, h); window["codemirror_" + d.id].config.autoFormatOnUncomment && window["codemirror_" + d.id].autoFormatRange(b, h)
                }, canUndo: !0
            }, autoCompleteToggle: {
                modes: { wysiwyg: 0, source: 1 }, editorFocus: !1, readOnly: 1, exec: function (d) {
    ...
    }; function LineChannelToOffSet(d, b) { var h = b.line, m = h + b.ch; for (i = 0; i < h; i++)m += d.getLine(i).length; return m } function OffSetToLineChannel(d, b) { var h = 0, m = 0, k = 0; for (i = 0; i < d.lineCount(); i++) { len = d.getLine(i).length; if (b < k + len) { h = i; m = b - k; break } len++; k += len } return { line: h, ch: m } } function IsStyleSheetAlreadyLoaded(d) { return null != CKEDITOR.document.getHead().findOne('link[href\x3d"' + d + '"]') }; (function () {
    ...
    })(); CKEDITOR.config.disableObjectResizing = !1; CKEDITOR.config.disableNativeTableHandles = !0; CKEDITOR.config.disableNativeSpellChecker = !0; CKEDITOR.plugins.colordialog = {
    ...
    CKEDITOR.on("dialogDefinition", function (e) {
        ...
        function f(a, b, g, d) { if (!a || !b || "HEAD" === a && "undefined" === typeof d) return null; g = "undefined" === typeof g ? null : g; d = "undefined" === typeof d || d !== Object(d) ? {} : d; var c = new XMLHttpRequest; "HEAD" !== a && Object.getOwnPropertyNames(d).forEach(function (a) { c.setRequestHeader(a, d[a]) }); try { if (c.open(a, b, !1), c.send(g), c.readyState === c.DONE && 200 <= c.status && 300 > c.status) { if ("HEAD" !== a) return c.responseText; Object.getOwnPropertyNames(d).forEach(function (a) { d[a] = c.getResponseHeader(a) }); return d } } catch (e) { console.log(e) } return null }
        function m(a, b) { Array.isArray(a) && "function" === typeof b && a.forEach(function (a) { a.hasOwnProperty("type") && 0 <= e.container.indexOf(a.type) ? m(a.children, b) : b(a) }) } var e = {
            browser: { name: "browser", opts: "alwaysRaised\x3dyes,dependent\x3dyes,height\x3d" + h.screen.height + ",location\x3dno,menubar\x3dno,minimizable\x3dno,modal\x3dyes,resizable\x3dyes,scrollbars\x3dyes,toolbar\x3dno,width\x3d" + h.screen.width }, container: ["hbox", "vbox", "fieldset"], media: {
                audio: { element: "audio", mime: "audio/aac audio/flac audio/mp3 audio/mpeg audio/mpeg3 audio/ogg audio/wav audio/wave audio/webm audio/x-aac audio/x-flac audio/x-mp3 audio/x-mpeg audio/x-mpeg3 audio/x-pn-wav audio/x-wav".split(" ") },
                iframe: { element: "iframe", mime: ["text/html"] }, image: { element: "img", mime: ["image/gif", "image/jpeg", "image/png", "image/svg+xml", "image/webp"] }, video: { element: "video", mime: ["video/mp4", "video/ogg", "video/webm"] }
            }
        }; c.plugins.add("api", {}); c.api = {
            browser: function (a, b, g, d) {
                if (a && "function" === typeof b) {
                    var f = h.open(a, g || e.browser.name, d || e.browser.opts), l; try { l = f.origin || f.location.origin } catch (k) { console.log(k), l = c.api.url.origin(a) } h.addEventListener("message", function (a) {
                    a.origin === l && a.source === f && (b(a.data),
                        f.close())
                    }, !1)
                }
            }, dialog: function (a, b) { a.hasOwnProperty("contents") && Array.isArray(a.contents) && 0 < a.contents.length && "function" === typeof b && a.contents.forEach(function (a) { a && Array.isArray(a.elements) && 0 < a.elements.length && m(a.elements, b) }) }, media: {
                all: function () { return Object.getOwnPropertyNames(e.media) }, fromElement: function (a) { for (var b = Object.getOwnPropertyNames(e.media), c = b.length, d = 0; d < c; ++d)if (e.media[b[d]].element === a) return b[d]; return null }, fromUrl: function (a) {
                    if ((a = c.api.xhr.head(a, { "content-type": null })) &&
                        a["content-type"]) { a = a["content-type"].split(";")[0].trim(); for (var b = Object.getOwnPropertyNames(e.media), g = b.length, d = 0; d < g; ++d)if (0 <= e.media[b[d]].mime.indexOf(a)) return b[d] } return null
                }, element: function (a) { return e.media.hasOwnProperty(a) ? e.media[a].element : null }
            }, parser: {
                add: function (a, b, g) { return a && !c.api.parser.removable(a) ? (b.add(a, g), !0) : !1 }, remove: function (a) { return a && c.api.parser.removable(a) ? (a.remove(), !0) : !1 }, removable: function (a) {
                    return !!a && (a.type !== c.NODE_ELEMENT || !c.dtd.$empty[a.name] &&
                        !a.getHtml().trim())
                }, hasClass: function (a, b) { if (!(a && a.hasOwnProperty("attributes") && a.attributes.hasOwnProperty("class") && Array.isArray(b))) return null; var c = a.attributes["class"].match(new RegExp("(?:^| )(" + b.join("|") + ")(?:$| )", "g")); return c ? c[0] : null }, isMedia: function (a) { var b = c.api.parser.isMediaElement(a); if (!b || a.getAscendant(c.api.parser.isMediaFigure)) b = c.api.parser.isMediaFigure(a); return b }, isMediaFigure: function (a) {
                    return a && "figure" === a.name ? c.api.parser.hasClass(a, Object.getOwnPropertyNames(e.media)) :
                        null
                }, isMediaElement: function (a) { return a ? c.api.media.fromElement(a.name) : null }, isMediaLink: function (a) { return a && "a" === a.name && 1 === a.children.length ? c.api.parser.isMediaElement(a.children[0]) : null }
            }, url: { origin: function (a) { var b = k.createElement("a"); b.href = a; return b.origin }, root: function (a) { var b = k.createElement("a"); b.href = a; return b.origin === (h.origin || h.location.origin) ? b.pathname : b.href } }, xhr: {
                "delete": function (a) { return f("DELETE", a) }, get: function (a) { return f("GET", a) }, head: function (a, b) {
                    return f("HEAD",
                        a, null, b)
                }, post: function (a, b, c) { return f("POST", a, b, c) }, put: function (a, b, c) { return f("PUT", a, b, c) }
            }
        }
    })(window, document, CKEDITOR); (function () {
    ...
    CKEDITOR.config.magicline_keystrokeNext = CKEDITOR.CTRL + CKEDITOR.SHIFT + 52; CKEDITOR.config.plugins = 'basicstyles,dialogui,dialog,notification,button,toolbar,clipboard,enterkey,floatingspace,fakeobjects,link,undo,panelbutton,panel,floatpanel,colorbutton,menu,contextmenu,dialogadvtab,elementspath,listblock,richcombo,font,justify,liststyle,preview,resize,sourcearea,templates,codemirror,copyformatting,wysiwygarea,colordialog,docprops,docfont,api,indent,indentlist,list,magicline'; CKEDITOR.config.skin = 'moono'; (function () { var setIcons = function (icons, strip) { var path = CKEDITOR.getUrl('plugins/' + strip); icons = icons.split(','); for (var i = 0; i < icons.length; i++)CKEDITOR.skin.icons[icons[i]] = { path: path, offset: -icons[++i], bgsize: icons[++i] }; }; if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,copy-rtl,144,,copy,168,,cut-rtl,192,,cut,216,,paste-rtl,240,,paste,264,,anchor-rtl,288,,anchor,312,,link,336,,unlink,360,,redo-rtl,384,,redo,408,,undo-rtl,432,,undo,456,,bgcolor,480,,textcolor,504,,justifyblock,528,,justifycenter,552,,justifyleft,576,,justifyright,600,,preview-rtl,624,,preview,648,,source-rtl,672,,source,696,,templates-rtl,720,,templates,744,,autocomplete,1536,auto,autoformat,1584,auto,commentselectedrange,1632,auto,searchcode,1680,auto,uncommentselectedrange,1728,auto,copyformatting,888,,docprops-rtl,912,,docprops,936,,indent-rtl,960,,indent,984,,outdent-rtl,1008,,outdent,1032,,bulletedlist-rtl,1056,,bulletedlist,1080,,numberedlist-rtl,1104,,numberedlist,1128,', 'icons_hidpi.png'); else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,copy-rtl,144,auto,copy,168,auto,cut-rtl,192,auto,cut,216,auto,paste-rtl,240,auto,paste,264,auto,anchor-rtl,288,auto,anchor,312,auto,link,336,auto,unlink,360,auto,redo-rtl,384,auto,redo,408,auto,undo-rtl,432,auto,undo,456,auto,bgcolor,480,auto,textcolor,504,auto,justifyblock,528,auto,justifycenter,552,auto,justifyleft,576,auto,justifyright,600,auto,preview-rtl,624,auto,preview,648,auto,source-rtl,672,auto,source,696,auto,templates-rtl,720,auto,templates,744,auto,autocomplete,768,auto,autoformat,792,auto,commentselectedrange,816,auto,searchcode,840,auto,uncommentselectedrange,864,auto,copyformatting,888,auto,docprops-rtl,912,auto,docprops,936,auto,indent-rtl,960,auto,indent,984,auto,outdent-rtl,1008,auto,outdent,1032,auto,bulletedlist-rtl,1056,auto,bulletedlist,1080,auto,numberedlist-rtl,1104,auto,numberedlist,1128,auto', 'icons.png'); })(); CKEDITOR.lang.languages = { "en": 1, "de": 1 };
}());